...
function ProfilePage() {
  ...
  return (
    <div className="relative h-[100vh] bg-gradient-to-br from-gray-950 via-indigo-950 to-purple-950 flex items-center justify-center p-4 overflow-hidden pt-[75px]">
